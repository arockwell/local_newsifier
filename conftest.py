...
from local_newsifier.models.analysis_result import AnalysisResult  # noqa: F401
# Apify models
from local_newsifier.models.apify import ApifyDatasetItem  # noqa: F401
from local_newsifier.models.apify import ApifyJob  # noqa: F401
from local_newsifier.models.apify import ApifySourceConfig  # noqa: F401
from local_newsifier.models.apify import ApifyCredentials, ApifyWebhook  # noqa: F401
# Core models
from local_newsifier.models.article import Article
# Import and register models in a specific order
# Base models
from local_newsifier.models.base import TableBase  # noqa: F401
from local_newsifier.models.entity import Entity  # noqa: F401
# Entity tracking models
from local_newsifier.models.entity_tracking import CanonicalEntity  # noqa: F401
from local_newsifier.models.entity_tracking import EntityMention  # noqa: F401
from local_newsifier.models.entity_tracking import EntityMentionContext  # noqa: F401
from local_newsifier.models.entity_tracking import EntityProfile, EntityRelationship  # noqa: F401
# Sentiment models
from local_newsifier.models.sentiment import SentimentAnalysis  # noqa: F401
from local_newsifier.models.sentiment import OpinionTrend, SentimentShift  # noqa: F401
# State models
from local_newsifier.models.state import AnalysisStatus, NewsAnalysisState  # noqa: F401
# Trend models
from local_newsifier.models.trend import TrendEntity  # noqa: F401
from local_newsifier.models.trend import TrendEvidenceItem  # noqa: F401
from local_newsifier.models.trend import TrendAnalysis, TrendStatus, TrendType  # noqa: F401
...
def test_engine(request):
    ...
    # Create a unique database URL for each worker (for xdist) or use shared memory
    # for single process
    if worker_id:
        # When running with xdist, each worker gets its own in-memory database with
        # its own ID. This ensures isolation between parallel test workers
    ...
    # Make the engine available to the plugin so it can be accessed outside the
    # fixture. This is the key change that avoids needing the problematic

...
We provide several testing utilities to simplify testing with injectable dependencies.
...
4. **create_mock_service**: A helper function to create service instances with mocked dependencies

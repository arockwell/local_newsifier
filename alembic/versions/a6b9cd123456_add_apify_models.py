...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_apify_source_configs_name"),
        "apify_source_configs",
        ["name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_apify_jobs_source_config_id"),
        "apify_jobs",
        ["source_config_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_apify_dataset_items_job_id"),
        "apify_dataset_items",
        ["job_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_apify_credentials_label"),
        "apify_credentials",
        ["label"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_apify_webhooks_webhook_id"),
        "apify_webhooks",
        ["webhook_id"],
        unique=False,
    )

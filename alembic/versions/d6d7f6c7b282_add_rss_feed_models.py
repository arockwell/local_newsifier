...
def upgrade() -> None:
    ...
    op.create_table('feed_processing_log',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_feed_processing_log_feed_id'), 'feed_processing_log', ['feed_id'], unique=False)
    op.create_index(op.f('ix_feed_processing_log_status'), 'feed_processing_log', ['status'], unique=False)

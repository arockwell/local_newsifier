...
class Settings(BaseSettings):
    ...
    SQLITE_URL: str = "sqlite:///local_newsifier.db"
    DB_POOL_SIZE: int = 5
    ...
    def get_database_url(self) -> str:
        ...
        # Use SQLite for testing or development if specified
        if self.USE_SQLITE or os.environ.get("USE_SQLITE", "").lower() in ("true", "1", "yes"):

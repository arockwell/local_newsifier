...
class Settings(BaseSettings):
    ...
    # Testing settings
    TEST_MODE: bool = Field(default=False, description="Flag to indicate if running in test mode")
    ...
    def validate_apify_token(self, skip_validation_in_test=False) -> str:
        ...
        import os
        in_test_env = os.environ.get("PYTEST_CURRENT_TEST") is not None or self.TEST_MODE

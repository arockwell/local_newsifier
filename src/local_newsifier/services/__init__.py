...
# Removing direct import of rss_feed_service to avoid circular imports
# from .rss_feed_service import rss_feed_service

# Global placeholders for services, to be set later
entity_service = None
...
# Function to register rss_feed_service, avoiding circular imports
def register_rss_feed_service(service_instance):
    """Register rss_feed_service to avoid circular imports.
    This will be called after the service is created.
    """
    global rss_feed_service
    rss_feed_service = service_instance

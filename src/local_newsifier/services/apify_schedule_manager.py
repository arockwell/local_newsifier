...
class ApifyScheduleManager:
    ...
    def sync_schedules(self) -> Dict[str, Any]:
        ...
        """
        results = {"created": 0, "updated": 0, "deleted": 0, "unchanged": 0, "errors": []}
    ...
    def verify_schedule_status(self, config_id: int) -> Dict[str, Any]:
        ...
        result = {"exists": False, "synced": False, "config_details": config_details}
        ...
        try:
            ...
            result["synced"] = (
                schedule.get("cronExpression") == config_details["schedule"]
                and schedule.get("actId") == config_details["actor_id"]
                and schedule.get("isEnabled") == config_details["is_active"]
            )

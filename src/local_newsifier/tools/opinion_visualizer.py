...
class OpinionVisualizerTool:
    ...
    def generate_text_report(
        self,
        visualization_data: Union[SentimentVisualizationData, Dict[str, SentimentVisualizationData]],
    ...
    def _generate_comparison_text_report(
        ...
        for topic, topic_data in data.items():
            ...
            avg_sentiment = sum(topic_data.sentiment_values) / len(topic_data.sentiment_values)

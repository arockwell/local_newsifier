...
from local_newsifier.models.database import (
    ...
    Base, Article, Entity, AnalysisResult
)
...
def test_add_analysis_result(db_manager: DatabaseManager, sample_article: ArticleCreate):
...
def test_update_article_status(db_manager: DatabaseManager, sample_article: ArticleCreate):

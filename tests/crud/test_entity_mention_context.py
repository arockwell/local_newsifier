...
from local_newsifier.crud.entity_mention_context import (
    CRUDEntityMentionContext, entity_mention_context as entity_mention_context_crud
)
...
class TestEntityMentionContextCRUD:
    ...
    def test_create(self, db_session, create_entity, sample_entity_mention_context_data):
        ...
        db_context = db_session.query(EntityMentionContextDB).filter(EntityMentionContextDB.id == context.id).first()
    ...
    def test_get_by_entity_and_article(self, db_session, create_entity, sample_entity_mention_context_data):
    ...
    def test_get_by_entity(self, db_session, create_entity):
        ...
        contexts = entity_mention_context_crud.get_by_entity(db_session, entity_id=create_entity.id)
    ...
    def test_get_sentiment_trend(self, db_session, create_canonical_entity, create_entity):

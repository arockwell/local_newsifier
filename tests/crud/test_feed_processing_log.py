...
def test_get_by_feed_id(db_session):
    ...
    # Test pagination
    paginated_logs = feed_processing_log.get_by_feed_id(db_session, feed_id=feed.id, skip=1, limit=1)
...
def test_get_by_status(db_session):
    ...
    # Test pagination
    paginated_success = feed_processing_log.get_by_status(db_session, status="success", skip=1, limit=1)

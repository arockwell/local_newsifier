...
class TestOpinionVisualizerTool:
    ...
    def test_injectable_compatibility(self, visualizer, mock_session, sample_data):
    ...
    def test_timeline_summary_helper(self, visualizer, sample_data):
    ...
    def test_comparison_summary_helper(self, visualizer, comparison_data):

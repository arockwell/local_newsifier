...
class TestOpinionVisualizerImplementation:
    ...
    @pytest.mark.skip(
        reason=(
            "Database integrity error with entity_mention_contexts.context_text, "
    ...
    def test_prepare_comparison_data_implementation(
        self, visualizer_with_db, sample_sentiment_data
    ):
    ...
    @pytest.mark.skip(
        reason=(
            "OpinionVisualizerTool has no attribute 'save_visualization', "
            "to be fixed in a separate PR"
        )
    )
    ...
    @pytest.mark.skip(
        reason=(
            "OpinionVisualizerTool has no attribute 'calculate_summary_stats', "
            "to be fixed in a separate PR"
        )
    )

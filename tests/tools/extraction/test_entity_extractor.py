...
class TestEntityExtractor:
    ...
    def test_extract_organization_entities(self, entity_extractor, basic_entities, mock_spacy_model):
    ...
    def test_extract_entities_with_context(self, entity_extractor, mock_spacy_model):
        ...
        entities = entity_extractor.extract_entities_with_context(
            "First sentence. John Smith is a person. Third sentence.",
            context_window=1
        )
    ...
    def test_extract_entities_with_malformed_content(self, entity_extractor, mock_spacy_model):
        ...
        with patch.object(entity_extractor, 'nlp', side_effect=ValueError("Error processing malformed text")):

...
class TestApifyScheduleCommands:
    ...
    def test_sync_schedules(
        self, mock_ensure_token, mock_get_schedule_manager, runner, mock_schedule_manager
    ):
    ...
    def test_get_schedule_manager(self):
        ...
        with patch("local_newsifier.cli.commands.apify.ApifyService") as mock_apify_service, patch(
            "local_newsifier.cli.commands.apify.get_session"
        ) as mock_get_session, patch(
            "local_newsifier.cli.commands.apify.ApifyScheduleManager"

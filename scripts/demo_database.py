...
from local_newsifier.models.database import ArticleCreate, EntityCreate, AnalysisResultCreate, ArticleDB
...
def show_database_state(db_manager):
    ...
    for article in articles:
        ...
        for entity in article.entities:
            logger.info(f"  - {entity.text} ({entity.entity_type}, confidence: {entity.confidence})")
...
def main():
    ...
    try:
        ...
        updated_article = db_manager.update_article_status(created_article.id, "analyzed")
        if updated_article:

...
def generate_report(slow_tests: List[Tuple[str, float]], all_durations: List[Tuple[str, float]]):
    ...
    print(f"Slow tests account for {slow_time / total_time * 100:.1f}% of total test time")
    print("═════════════════════════════════════")
    ...
    print("═════════════════════════════════════")
    for module, tests in sorted(modules.items(), key=lambda x: sum(t[1] for t in x[1]), reverse=True):
